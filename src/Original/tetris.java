...
public class tetris extends Applet {
	...
	private static class TetrisLabel extends Label {
		private final static Font LABEL_FONT = new Font("Arial", Font.PLAIN, 15);
	...
	// INSTANCE DATA
	//
	public static Frame frame = new Frame("Tetris");	
	...
	private class TetrisButton extends Button {
                private final Font BUTTON_FONT = new Font("Arial", Font.ITALIC, 15);
	...
	private void gameOver() {
		...
		if(score > high_score)
			high_score_label.setText("" + score);
                ...
                MsgBox message = new MsgBox (frame , "Game Over. Your score is "+ score +".", true);
        ...
        // To display a dialogue once game is over
	...
	public void init() {
		...
		right_panel.add(tmp);
                ...
                start_newgame_butt.setLocation(25, 50);
